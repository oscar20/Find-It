...
class UbicacionViewController: UIViewController {
    ...
    func setupMapa(){
        ...
        let miCoordenadaActual = CLLocationCoordinate2DMake(puntoLatitud, puntoLongitud)
        ...
        mapView = GMSMapView.map(withFrame: CGRect(x: 0.0, y: 0.0, width: UIScreen.main.bounds.width, height: UIScreen.main.bounds.height), camera: camera2)
        view = mapView
        setupMarkersMap()
